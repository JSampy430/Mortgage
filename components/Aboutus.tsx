      ...
      <section className="py-20 px-6 sm:px-12 lg:px-24 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-12">
            We are committed to helping families and individuals unlock the
            doors to their dream homes with ease, trust, and transparency. Our
            team works tirelessly to provide the best mortgage solutions
            tailored to each client’s unique needs.
          </p>

          <h2 className="text-3xl md:text-4xl font-bold mb-6">Our Vision</h2>
          <p className="text-lg text-gray-600">
            To become the most trusted mortgage platform in the UAE by
            delivering unmatched service, innovative tools, and a people-first
